  ...
  inputs = rec {
    ...
    pythoneda-sandbox-python-dep = {
      ...
      inputs.pythoneda-shared-pythoneda-domain.follows =
        "pythoneda-shared-pythoneda-domain";
      url =
        "github:pythoneda-sandbox/python-dep-artifact/0.0.141?dir=python-dep";
    };
  };
  outputs = inputs:
    with inputs;
    ...
    in flake-utils.lib.eachSystem supportedSystems (system:
      let
        ...
        repo = "python";
        version = "0.0.146";
        sha256 = "1i8b749q36xm2cs4n0q4l726f9anznnlkinxzbic3k1ksqby8hxm";
        pname = "${org}-${repo}";
        ...
        pythoneda-sandbox-python-for = { python
          , pythoneda-shared-pythoneda-domain, pythoneda-sandbox-python-dep }:
          let
